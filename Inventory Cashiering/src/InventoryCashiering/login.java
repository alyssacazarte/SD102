...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/InventoryCashiering/sweetshop1.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/InventoryCashiering/close-removebg-preview.png"))); // NOI18N
    ...
    if (email.isEmpty() || password.isEmpty()) {
      ...
      try {
        ...
        this.prest = (PreparedStatement)this.con.prepareStatement("SELECT * FROM users WHERE email= '" + email + "' AND password = '" + password + "'");
        this.result = (ResultSet)this.prest.executeQuery();
        if (this.result.next()) {
          String accountrole = this.result.getString("role");
          String status = this.result.getString("status");
          if ("inactive".equals(status) && "staff".equals(accountrole)) {
            JOptionPane.showMessageDialog(null, "Your Account has been deactivated by the Admin");
          } else if ("inactive".equals(status) && "cashier".equals(accountrole)) {
            JOptionPane.showMessageDialog(null, "Your Account has been deactivated by the Admin");
          } else if ("inactive".equals(status) && "admin".equals(accountrole)) {
            JOptionPane.showMessageDialog(null, "Your Account has been deactivated by the Admin");
            ...
            JOptionPane.showMessageDialog(this, "Welcome to HoleBunchSweetShop");
            JOptionPane.showMessageDialog(this, "Successfully logined as an Admin");
    ...
    private void signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupActionPerformed
       registrationform regisf = new registrationform();
       hide();
       regisf.setVisible(true);
