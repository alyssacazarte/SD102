...
public class cashier extends javax.swing.JFrame {
    ...
    private void table_update()
    {
        try {
            ...
            try {
                ...
                prest = (PreparedStatement) con.prepareStatement("select * from cashier");
                ...
                while(result.next())
                {
                    ...
                    for(int i=1; i<=mini; i++)
                    {
                        ...
                        vc.add(result.getString("username"));
                        vc.add(result.getString("password"));
                        vc.add(result.getString("contact"));
                        vc.add(result.getString("address"));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "First Name", "Last Name", "Username", "Password", "Contact", "Address", "Email"
            }
        ) {
    ...
    private void createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createActionPerformed
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/minimall","root","");
            prest = (PreparedStatement) con.prepareStatement("insert into cashier (first_name,last_name,username,password,contact,address,email)values(?,?,?,?,?,?,?)");
            prest.setString (1, firstname);
            prest.setString (2, lastname);
            prest.setString (3, username);
            prest.setString (4, password);
            prest.setString (5, contact);
...
//            txtusername.requestFocus();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtfirstname.setText(dtm1.getValueAt(selectIndex, 1).toString());
        txtlastname.setText(dtm1.getValueAt(selectIndex, 2).toString());
        txtusername.setText(dtm1.getValueAt(selectIndex, 3).toString());
        txtpassword.setText(dtm1.getValueAt(selectIndex, 4).toString());
        txtcontact.setText(dtm1.getValueAt(selectIndex, 5).toString());
        txtaddress.setText(dtm1.getValueAt(selectIndex, 6).toString());
        txtemail.setText(dtm1.getValueAt(selectIndex, 7).toString());
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
      ...
      String email = txtemail.getText();
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/minimall","root","");
            prest = (PreparedStatement) con.prepareStatement("update cashier set first_name=?, last_name=?, username=?, password=?, contact=?, address=?, email=? where id=?");
            prest.setString (1, firstname);
            prest.setString (2, lastname);
            prest.setString (3, username);
            prest.setString (4, password);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
      ...
      int dialogResult = JOptionPane.showConfirmDialog(null,"Do you want to Delete this Cashier Account", "Warning",JOptionPane.YES_NO_OPTION);
      ...
      if(dialogResult == JOptionPane.YES_OPTION)
      {
          try {
              Class.forName("com.mysql.jdbc.Driver");
              con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/minimall","root","");
              prest = (PreparedStatement) con.prepareStatement("delete from cashier where id=?");
              prest.setInt (1, id);
              prest.executeUpdate();
